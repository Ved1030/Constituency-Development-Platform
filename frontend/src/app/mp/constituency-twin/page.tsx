    ...
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-foreground">Constituency Digital Twin</h1>
        </div>
        <p className="mt-1 text-sm text-muted-foreground">Interactive geospatial view of North Chennai with multi-layer GIS overlays.</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-4">
        ...
        >
          <h3 className="mb-3 flex items-center gap-2 text-sm font-semibold text-foreground">
            <Layers className="size-4 text-emerald-600" /> Map Layers
          </h3>
          ...
          <div className="absolute inset-0 overflow-hidden rounded-2xl">
            ...
            <div className="absolute bottom-4 left-4 flex items-center gap-4 rounded-lg bg-white/90 border border-border px-4 py-2.5 backdrop-blur-sm">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] text-muted-foreground">High Complaint</span>
              </div>
              <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] text-muted-foreground">142 Villages | 72 Wards</span>
            </div>
          </div>
        </motion.div>
      </div>
